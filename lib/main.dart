...
import 'package:instagram_anshumali/providers/user_provider.dart';
...
import 'package:instagram_anshumali/screens/login_screen.dart';
  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyBWE0bMsBh5ivojHPvUsNCEX82YCgAnImw",
        appId: "1:373934317637:web:7030f09c944b9200bc032c",
        messagingSenderId: "373934317637",
        projectId: "instagram-bd926",
        storageBucket: "instagram-bd926.appspot.com",
      ),
    );
  } else {
    await Firebase.initializeApp();
